...
description: Planned features for Skivjansen — release images, details view, barcode scanning, cache versioning
type: project
---
...
4. Bump sw.js cache version on updates — currently hardcoded as `skivjansen-v1`
